...
public class Meteorite : Plantes {
    public Meteorite(int[] position) : base("Météorite", position, "Monocarpique", false, new Saison1(), "Petit Prince", 1, [], [150], 24, 0, new List<Maladies> {}, 6, 2,"☄️") {
...
public class Nuage : Plantes {
    public Nuage(int[] position) : base("Nuage", position, "Polycarpique", true, new Saison2(), "Aucun", 1, [], [100], 72, 3, new List<Maladies> {}, 2, 1,"☁️") {}
}
